...
<script>
  ...
  export default {
    ...
    computed: {
      ...
      cover() {
        return this.$themeConfig.covers[new Date().getDay()] || "http://cnd.yinglingxuan.cn/myPng/1.jpg"
      },
      pageCover() {
        return this.$page.frontmatter.cover || this.$themeConfig.covers[new Date().getDay()] || "http://cnd.yinglingxuan.cn/myPng/1.jpg"
      },
      shouldShowNavbar() {
    ...
    mounted() {
      ...
      this.cover = this.$themeConfig.covers[new Date().getDay()]
      setInterval(() => {
        this.qieHuanBg()
      },10000)
      this.hasKey()
    ...
    methods: {
      qieHuanBg () {
        this.cover = this.$themeConfig.covers[Math.floor(Math.random() * this.$themeConfig.covers.length)]
